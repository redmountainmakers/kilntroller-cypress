...
static void AnalogSetDefault(void)
{
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTBM_OA0_SW, 0x00240100u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x00408000u);
...
void AMux_1_Set(uint8 channel)
{
	switch (channel) {
		case 0u:
			...
			break;
		case 1u:
			CY_SET_REG32((void CYXDATA *)CYREG_CTBM_OA0_SW, (0x01u));
...
void AMux_1_Unset(uint8 channel)
{
	switch (channel) {
		case 0u:
			...
			break;
		case 1u:
			CY_SET_REG32((void CYXDATA *)CYREG_CTBM_OA0_SW_CLEAR, (0x01u));
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_UDB_PA1_CFG8), 0x05000000u);
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYDEV_PRT1_BASE), 0x00000037u);
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_PRT1_PC), 0x00180000u);
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_PRT1_PC2), 0x000000B7u);
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_PRT3_PC), 0x00200D80u);
