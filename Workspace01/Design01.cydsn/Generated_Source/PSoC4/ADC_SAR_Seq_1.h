...
#define ADC_SAR_Seq_1_DEFAULT_AVG_SAMPLES_NUM        (7u)
#define ADC_SAR_Seq_1_DEFAULT_AVG_SAMPLES_DIV        (int16)(0x100u >> (7u - 7u))
...
#define ADC_SAR_Seq_1_SAR_CHAN7_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT07 )
    ...
    #define ADC_SAR_Seq_1_SAR_CHAN8_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT08 )
    #define ADC_SAR_Seq_1_SAR_CHAN8_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT08 )

    #define ADC_SAR_Seq_1_SAR_CHAN9_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT09 )
    #define ADC_SAR_Seq_1_SAR_CHAN9_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT09 )

    #define ADC_SAR_Seq_1_SAR_CHAN10_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT010 )
    #define ADC_SAR_Seq_1_SAR_CHAN10_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT010 )

    #define ADC_SAR_Seq_1_SAR_CHAN11_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT011 )
    #define ADC_SAR_Seq_1_SAR_CHAN11_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT011 )

    #define ADC_SAR_Seq_1_SAR_CHAN12_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT012 )
    #define ADC_SAR_Seq_1_SAR_CHAN12_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT012 )

    #define ADC_SAR_Seq_1_SAR_CHAN13_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT013 )
    #define ADC_SAR_Seq_1_SAR_CHAN13_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT013 )

    #define ADC_SAR_Seq_1_SAR_CHAN14_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT014 )
    #define ADC_SAR_Seq_1_SAR_CHAN14_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT014 )

    #define ADC_SAR_Seq_1_SAR_CHAN15_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT015 )
    #define ADC_SAR_Seq_1_SAR_CHAN15_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT015 )
